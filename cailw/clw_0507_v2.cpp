...
#define EDGE_ITR_INIT(u, v)\
                ...
                if (node_info[v].first != itr_##u) node_info[v].first = itr_ ##u;
...
#define REV_POSSIBLE(x, v) if ((amount_##x > 5ll * rev_node_info[v].max) and (3ll * amount_##x < rev_node_info[v].min)) continue;
